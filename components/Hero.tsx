  ...
  useGSAP(() => {
    ...
    scrollTl
      .fromTo(
        ...
        { backgroundColor: "#D9F990", overwrite: "auto" },
        1,
      )
      ...
      <div className="grid">
        <div className="grid text-center">
          <TextSplitter
            ...
            className="hero-header-word mt-10 lg:text-[13rem] text-7xl font-black uppercase leading-[.8] text-orange-600 md:text-[9rem]"
          />
